...
public class Schleifen {
    public static void main(String[] args) {
        // Geben Sie die Zahlen von 70 bis 100 Zeile für Zeile auf der
        // Konsole aus
        System.out.println(
                "Zahlen von 70 bis 100, Zeile für Zeile, auf der Konsole:");
        ...
        System.out.println(
                "Zahlen von 70 bis 100, mit Beistrich getrennt, auf der " +
                        "Konsole:");
        for (int i = 70; i <= 100; i++) {
            // System.out.print() <-- Ausgabe ohne Zeilenumbruch
            System.out.print(i);
            // Wenn ich NICHT bei der letzten Zahl bin, dann einen Beistrich
            // ausgeben
        ...
        System.out.println();
        System.out.println(
                "Zahlen von 120 bis 100, mit Beistrich getrennt, auf Konsole:");
        ...
        // Am Ende der Schleife einen Zeilenumbruch damit man danach eine
        // neue Zeile hat
        System.out.println();

        System.out.println("Ausgabe von einem String: Jedes Zeichen soll mit " +
                "Beistrich getrennt extra ausgegeben werden Hello --> H, e, " +
                "l, l, o");
        String text = "Hello";
        // text.length() <-- Anzahl der Zeichen im String: Hello --> 5
        // text.charAt(index) <-- Liefert das Zeichen am gegebenen Index
        // "Hello".charAt(0) --> H
        // text.charAt(index) <-- Liefert das Zeichen am gegebenen Index
        // "Hello".charAt(4) --> o
        for (int i = 0; i < text.length(); i++) {
            ...
            // Wenn wir nicht beim letzten Zeichen sind, dann einen Beistrich
            // ausgeben
